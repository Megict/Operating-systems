...
int CreateQueue(msQ* queue,int maxLOGlen); //принимается указатель на массив из 2-х элементов. Процесс, создавший оператор получает его публичные порты. Возвращается PID оператора
